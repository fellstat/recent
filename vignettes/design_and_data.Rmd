...
For the LAg-Avidity assay, we recommend the use of the q(t) curve from Fellows et. al. [1], which is based on data from [2]. For reference FRR, the only study we are aware of that was conducted in a non-elite controller, untreated, non-AIDS population was [TODO: cite], who reported a reference false recency rate of 0.55%.
